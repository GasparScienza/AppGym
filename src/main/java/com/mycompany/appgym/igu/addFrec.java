...
public class addFrec extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblFechaPago5.setText("*Frecuencia:");

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 36)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Agregar Frecuencia");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(txtFrec, javax.swing.GroupLayout.DEFAULT_SIZE, 224, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(txtFrec.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "El campo obligatorio no fue completado");
        }else{
            frec.setType(txtFrec.getText());

            ctrP.addF(frec);
            this.txtFrec.setText("");
